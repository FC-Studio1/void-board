    ...
    <n-scrollbar style="max-height: calc(100vh)">
      <n-card style="width: 85%; margin: 1.5% 7.5% -1% 7.5%">
        ...
        <n-space justify="space-around">
          <h1 v-if="!editTitle" style="margin-top: -1%; margin-bottom: -1%">
            {{ title }}
          </h1>
          <n-input
            v-if="editTitle"
      ...
      <n-space justify="center" size="large" style="margin-top: 3%">
        <n-card
          ...
          :class="
            ('main',
            {
              act: (active1 && tab == '倒计时') || (!stop1 && tab == '秒表'),
              end: end1,
            })
          "
          ><n-tabs
            ...
            @update:value="
              tab == '倒计时' ? (end1 = end1) : (end1 = end2 = false)
            "
          >
            <template #suffix>
              <div v-show="!stop1 && tab == '倒计时'">
                <n-tag :bordered="false" type="info">秒表运行中</n-tag>
              </div>
              <div v-show="active1 && tab == '秒表'">
                <n-tag :bordered="false" type="info">倒计时运行中</n-tag>
              </div>
              <div v-show="!active1 && tab == '秒表' && end1">
                <n-tag :bordered="false" type="error">倒计时已结束 ! </n-tag>
              </div>
            </template>
            <n-tab-pane name="倒计时" tab="倒计时" display-directive="show">
              <div class="countdown" style="margin-top: 20%">
                <n-countdown
                  :duration="(h1 * 3600 + m1 * 60 + s1) * 1000"
                  :active="active1"
                  ref="countdownRef1"
                  :precision="2"
                  :on-finish="finish1"
              ...
              >
                <n-button
                  ...
                  secondary
                  type="info"
                  @click="(active1 = !active1), (end1 = false)"
                  :disabled="
                    (h1 <= 0 && m1 <= 0 && s1 <= 0) || end1 || !canStart1
                  "
                  class="countdown-btn"
                >
              ...
              <n-space vertical>
                <n-button
                  ...
                  quaternary
                  type="default"
                  style="float: left; margin: 10px 0 0; padding: 10px"
                  @click="show1 = !show1"
                >
                  <n-icon size="20">
                    <SettingsOutline />
        ...
        <n-card
          ...
          :class="
            ('main',
            {
              act: (active2 && tab == '倒计时') || (!stop2 && tab == '秒表'),
              end: end2,
            })
          "
          ><n-tabs
            ...
            v-model:value="tab"
            @update:value="
              tab == '倒计时' ? (end2 = end2) : (end1 = end2 = false)
            "
          >
            <template #suffix>
            ...
            <n-tab-pane name="倒计时" tab="倒计时" display-directive="show">
              <div class="countdown" style="margin-top: 20%">
                <n-countdown
                  :duration="(h2 * 3600 + m2 * 60 + s2) * 1000"
                  :active="active2"
                  :precision="2"
                  ref="countdownRef2"
                  :on-finish="finish2"
              ...
              >
                <n-button
                  ...
                  secondary
                  type="info"
                  @click="(active2 = !active2), (end2 = false)"
                  :disabled="
                    (h2 <= 0 && m2 <= 0 && s2 <= 0) || end2 || !canStart2
                  "
                  class="countdown-btn"
                >
      ...
      <n-card style="width: 85%; margin: 2% 7.5% 2% 7.5%">
        ...
        <n-button
          type="default"
          @click="
            ((stop1 = false), (stop2 = false), timer1(stop1)), timer2(stop2)
          "
          style="margin: 0px 20px"
          tertiary
        ...
        <n-button
          type="default"
          @click="
            ((stop1 = true), (stop2 = true), timer1(stop1)), timer2(stop2)
          "
          style="margin: 0px 20px"
          tertiary
          :disabled="stop1 || stop2"
        ...
        <n-button
          type="default"
          @click="
            ((stop1 = !stop1), (stop2 = !stop2), timer1(stop1)), timer2(stop2)
          "
          style="margin: 0px 20px"
          tertiary
          v-show="tab === '秒表'"
